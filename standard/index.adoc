:title: WMO WIS2 Monitoring and Alerting
:titletext: {title}
...
include::sections/clause_7_alerting_hierarchy.adoc[]

include::sections/clause_8_event_message_encoding_core.adoc[]

//include::sections/clause_9_monitoring_message_wcmp2_ets.adoc[]

//include::sections/clause_10_monitoring_message_wcmp2_kpi.adoc[]
