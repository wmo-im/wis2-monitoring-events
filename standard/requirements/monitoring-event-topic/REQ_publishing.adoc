...
^|A |Events SHALL NOT be published with a topic that is not defined in the WMET.
...
^|F |Event topic level 4 SHALL be a centre identifier (as per the <<wis2-topic-hierarchy, WIS2 Topic Hierarchy>>) of the subject of the event.
|===
