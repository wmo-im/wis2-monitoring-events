...
=== WIS2 Monitoring Event Message: WCMP2 ETS Report
...
=== WIS2 Monitoring Event Message: WCMP2 KPI Report
...
=== WIS2 Monitoring Event Message: WNM Schema Compliance Report
...
=== WIS2 Monitoring Event Message: Alert Report
