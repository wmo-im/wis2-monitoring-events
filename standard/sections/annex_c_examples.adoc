...
=== WIS2 Monitoring Event Message Encoding: Alert Report

.Example: Alert report event notification from a WIS2 Global Broker, concerning a data notification missing a metadata identifier reference
[source,json]
----
