...
A simple ruleset is defined for publishing events to WET that enables the clear identification of the event producer and its subject, to trigger corrective action.
